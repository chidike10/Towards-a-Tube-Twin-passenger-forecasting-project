...
def main():
    ...
    if page_selection == "Graphical Network Representation":
        with header:
            ...
            st.markdown(
                'Already we can even do some analysing on the graph, like getting a reasonable (shortest) path between two stations by choosing `source_station` and `target_station` below')
    ...
    if page_selection == 'About The Team':
        ...
        with col10:
            ...
            st.markdown("<p>LinkedIn</b>: <a href='www.linkedin.com/in/hodumuko'>Harmony Odumuko</a>"
                        ...
                        "<br>Contact:</b>: +2348024541916<br>"
                        "<b>About</b>: Harmony Odumuko is a Data scientist with strong analytical background, using predictive modeling, "
                        "data processing, and data mining methods to address difficult business problems.Involved in mentoring "
                        "upcoming cloud techies and passionate about digital twin projects. </p>", unsafe_allow_html = True)
        ...
        with col12:
            ...
            st.markdown("<p>LinkedIn</b>: <a href='www.linkedin.com/in/endurance-arienkhe'>Endurance Arienkhe</a>"
                        ...
                        "<br>Contact:</b>: +2347065516048<br>"
                        "<b>About</b>: Data Science enthusiast with a passion for data integrity, visualization, and statistics.I’m "
                        "always excited to apply my passion for data science to provide insightful, high-quality "
                        "data analytics and visualizations. </p>", unsafe_allow_html = True)
