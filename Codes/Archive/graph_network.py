...
def main(): 
    ...
    if page_selection == "Graph Network": 
        with header:
                ...
                # graph_renderer = from_networkx(simple_graph, nx.circular_layout, scale=1, center=(0,0)) 
                ...
                # plot = figure(title="Londo Underground Graph Representation", width=800, height=600, x_range=(-1.1,1.1), y_range=(-1.1,1.1),
                #             tools="", toolbar_location='above') 

                # plot.add_tools(HoverTool(tooltips=None), TapTool(), BoxSelectTool()) 

                # plot_1 = from_networkx(simple_graph, nx.spring_layout, scale=2, center=(0,0)) 
                # plot.renderers.append(plot_1) 
